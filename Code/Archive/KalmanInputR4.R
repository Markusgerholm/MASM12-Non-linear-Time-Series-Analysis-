predValuesInputR4 <- function(inputdata, kStep){
  # Function for predicting input for R4 - Ullared
  x <-  inputdata
  k <-  kStep
  ...
  #1.8190  -0.8719  -0.4983  -0.0405  15.0508
  #s.e.  0.0136   0.0128   0.0237   0.0197   0.1790
  
  #sigma^2 = 1.14:  log likelihood = -3976.25
  #AIC=7964.5   AICc=7964.53   BIC=7999.91
  
  #Training set error measures:
  #                       ME     RMSE       MAE        MPE     MAPE     MASE         ACF1
  #Training set -0.0002605539 1.066747 0.7513348 -0.7314729 5.577717 0.752519 -0.001808906
