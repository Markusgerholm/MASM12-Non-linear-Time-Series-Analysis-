predValuesInputR1 <- function(inputdata, kStep){
  # Function for predicting input for R1 - Hörby
  x <-  inputdata
  k <-  kStep
  ...
  #Coefficients:
  #  ar1      ma1     ma2     ma3
  #0.6093  -0.2361  0.0938  0.0688
  #s.e.  0.0453   0.0484  0.0242  0.0236
  
  #sigma^2 = 0.8238:  log likelihood = -3567.59
  #AIC=7145.18   AICc=7145.2   BIC=7174.68
  
  #Training set error measures:
  #                       ME      RMSE       MAE        MPE     MAPE     MASE         ACF1
  #Training set -0.0001528766 0.9067757 0.6409996 0.05102997 4.082731 0.801955 0.0001193557
